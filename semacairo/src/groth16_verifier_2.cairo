...
fn get_vk(depth: u8) -> garaga::ec::pairing::groth16::Groth16VerifyingKey::<garaga::definitions::structs::fields::u288> {
    if depth == 4 {
        return super::g16v_4_constants::vk;
    } else if depth == 5 {
        return super::g16v_5_constants::vk;
    } else if depth == 6 {
        return super::g16v_6_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 4 {
        return super::g16v_4_constants::ic;
    } else if depth == 5 {
        return super::g16v_5_constants::ic;
    } else if depth == 6 {
        return super::g16v_6_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(depth: u8) -> [garaga::definitions::structs::points::G2Line::<garaga::definitions::structs::fields::u288>; 176] {
    if depth == 4 {
        return super::g16v_4_constants::precomputed_lines;
    } else if depth == 5 {
        return super::g16v_5_constants::precomputed_lines;
    } else if depth == 6 {
        return super::g16v_6_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_2 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_2 of ISemaphoreVerifier<ContractState> {
