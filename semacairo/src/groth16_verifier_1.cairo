...
fn get_vk(depth: u8) -> garaga::ec::pairing::groth16::Groth16VerifyingKey::<garaga::definitions::structs::fields::u288> {
    if depth == 1 {
        return super::g16v_1_constants::vk;
    } else if depth == 2 {
        return super::g16v_2_constants::vk;
    } else if depth == 3 {
        return super::g16v_3_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 1 {
        return super::g16v_1_constants::ic;
    } else if depth == 2 {
        return super::g16v_2_constants::ic;
    } else if depth == 3 {
        return super::g16v_3_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(depth: u8) -> [garaga::definitions::structs::points::G2Line::<garaga::definitions::structs::fields::u288>; 176] {
    if depth == 1 {
        return super::g16v_1_constants::precomputed_lines;
    } else if depth == 2 {
        return super::g16v_2_constants::precomputed_lines;
    } else if depth == 3 {
        return super::g16v_3_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_1 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_1 of ISemaphoreVerifier<ContractState> {
