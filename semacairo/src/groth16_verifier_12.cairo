...
fn get_vk(
    ...
    if depth == 31 {
        return super::g16v_31_constants::vk;
    } else if depth == 32 {
        return super::g16v_32_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 31 {
        return super::g16v_31_constants::ic;
    } else if depth == 32 {
        return super::g16v_32_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(
    ...
    176] {
    if depth == 31 {
        return super::g16v_31_constants::precomputed_lines;
    } else if depth == 32 {
        return super::g16v_32_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_12 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_12 of ISemaphoreVerifier<ContractState> {
