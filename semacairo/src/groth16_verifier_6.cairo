...
fn get_vk(
    ...
    if depth == 16 {
        return super::g16v_16_constants::vk;
    } else if depth == 17 {
        return super::g16v_17_constants::vk;
    } else if depth == 18 {
        return super::g16v_18_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 16 {
        return super::g16v_16_constants::ic;
    } else if depth == 17 {
        return super::g16v_17_constants::ic;
    } else if depth == 18 {
        return super::g16v_18_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(
    ...
    176] {
    if depth == 16 {
        return super::g16v_16_constants::precomputed_lines;
    } else if depth == 17 {
        return super::g16v_17_constants::precomputed_lines;
    } else if depth == 18 {
        return super::g16v_18_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_6 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_6 of ISemaphoreVerifier<ContractState> {
