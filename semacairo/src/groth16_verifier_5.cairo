...
fn get_vk(depth: u8) -> garaga::ec::pairing::groth16::Groth16VerifyingKey::<garaga::definitions::structs::fields::u288> {
    if depth == 13 {
        return super::g16v_13_constants::vk;
    } else if depth == 14 {
        return super::g16v_14_constants::vk;
    } else if depth == 15 {
        return super::g16v_15_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 13 {
        return super::g16v_13_constants::ic;
    } else if depth == 14 {
        return super::g16v_14_constants::ic;
    } else if depth == 15 {
        return super::g16v_15_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(depth: u8) -> [garaga::definitions::structs::points::G2Line::<garaga::definitions::structs::fields::u288>; 176] {
    if depth == 13 {
        return super::g16v_13_constants::precomputed_lines;
    } else if depth == 14 {
        return super::g16v_14_constants::precomputed_lines;
    } else if depth == 15 {
        return super::g16v_15_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_5 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_5 of ISemaphoreVerifier<ContractState> {
