...
fn get_vk(depth: u8) -> garaga::ec::pairing::groth16::Groth16VerifyingKey::<garaga::definitions::structs::fields::u288> {
    if depth == 10 {
        ...
        return super::g16v_11_constants::vk;
    } else if depth == 12 {
        return super::g16v_12_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 10 {
        return super::g16v_10_constants::ic;
    } else if depth == 11 {
        return super::g16v_11_constants::ic;
    } else if depth == 12 {
        return super::g16v_12_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(depth: u8) -> [garaga::definitions::structs::points::G2Line::<garaga::definitions::structs::fields::u288>; 176] {
    if depth == 10 {
        ...
        return super::g16v_11_constants::precomputed_lines;
    } else if depth == 12 {
        return super::g16v_12_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_4 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_4 of ISemaphoreVerifier<ContractState> {
