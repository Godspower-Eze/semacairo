...
fn get_vk(
    ...
    if depth == 22 {
        return super::g16v_22_constants::vk;
    } else if depth == 23 {
        return super::g16v_23_constants::vk;
    } else if depth == 24 {
        return super::g16v_24_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 22 {
        return super::g16v_22_constants::ic;
    } else if depth == 23 {
        return super::g16v_23_constants::ic;
    } else if depth == 24 {
        return super::g16v_24_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(
    ...
    176] {
    if depth == 22 {
        return super::g16v_22_constants::precomputed_lines;
    } else if depth == 23 {
        return super::g16v_23_constants::precomputed_lines;
    } else if depth == 24 {
        return super::g16v_24_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_8 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_8 of ISemaphoreVerifier<ContractState> {
