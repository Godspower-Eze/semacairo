...
fn get_vk(depth: u8) -> garaga::ec::pairing::groth16::Groth16VerifyingKey::<garaga::definitions::structs::fields::u288> {
    if depth == 19 {
        return super::g16v_19_constants::vk;
    } else if depth == 20 {
        return super::g16v_20_constants::vk;
    } else if depth == 21 {
        return super::g16v_21_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 19 {
        return super::g16v_19_constants::ic;
    } else if depth == 20 {
        return super::g16v_20_constants::ic;
    } else if depth == 21 {
        return super::g16v_21_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(depth: u8) -> [garaga::definitions::structs::points::G2Line::<garaga::definitions::structs::fields::u288>; 176] {
    if depth == 19 {
        return super::g16v_19_constants::precomputed_lines;
    } else if depth == 20 {
        return super::g16v_20_constants::precomputed_lines;
    } else if depth == 21 {
        return super::g16v_21_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_7 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_7 of ISemaphoreVerifier<ContractState> {
