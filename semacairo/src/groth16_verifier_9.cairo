...
fn get_vk(
    ...
    if depth == 25 {
        return super::g16v_25_constants::vk;
    } else if depth == 26 {
        return super::g16v_26_constants::vk;
    }
...
fn get_ic(depth: u8) -> [G1Point; 5] {
    if depth == 25 {
        return super::g16v_25_constants::ic;
    } else if depth == 26 {
        return super::g16v_26_constants::ic;
    }
    panic!("Unsupported depth")
}
...
fn get_precomputed_lines(
    ...
    176] {
    if depth == 25 {
        return super::g16v_25_constants::precomputed_lines;
    } else if depth == 26 {
        return super::g16v_26_constants::precomputed_lines;
    }
    panic!("Unsupported depth")
}

#[starknet::contract]
mod Semaphore_Groth16VerifierBN254_9 {
    ...
    #[abi(embed_v0)]
    impl ISemaphore_Groth16VerifierBN254_9 of ISemaphoreVerifier<ContractState> {
